...
print('Exercise 1 pt. 2:', calculate_area_triangle(7, 3))
...
print('Exercise 2 pt. 2:', simple_interest(1500, 3.5, 5))
...
print('Exercise 3 pt. 2:', apply_discount(80, 10))
...
print('Exercise 4 pt. 2: Convert 32°F to Celsius:', convert_temperature(32, 'F'))
...
def sum_to(n):
    ...
    # range(start at 1, stop at n + 1, so n is included, step defaults to 1 if not included)
    return sum(range(1, n + 1)) 

print('Exercise 5:', sum_to(6))
print('Exercise 5 pt. 2:', sum_to(10)) 
...
print('Exercise 6 pt. 2:', largest(10, 4, 2))
...
# tip percentage should be whole number only...
...
print('Exercise 8 pt 2:', product(2, 5, 5))
...
print('Exercise 9 pt. 2 Result:', basic_calculator(10, 5, "add"))  
print('Exercise 9 pt. 3 Result:', basic_calculator(10, 5, "multiply"))
print('Exercise 9 pt. 4 Result:', basic_calculator(10, 5, "divide")) 